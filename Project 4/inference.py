...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for i in self.allPositions:
            b = self.getObservationProb(observation, gameState.getPacmanPosition(), i, self.allPositions[len(self.allPositions)-1])
            self.beliefs[i] *= b
        self.beliefs.normalize()
...
class ParticleFilter(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        particles = []
        for p in self.particles:
            posDist = self.getPositionDistribution(gameState, p)
            particles.append(posDist.sample())
